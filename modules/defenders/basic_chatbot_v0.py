...
def run_basic_chatbot_v0(user_input: str, history: list = None, defender_state: dict = None):
    ...
    try:
        ...
        duration = (time.perf_counter() - start_time) * 1000
        print(f"TIMEOUT in basic_chatbot_v0")
        return [{
            "role": "defender",
            "model_used": res_model,
        ...
        duration = (time.perf_counter() - start_time) * 1000
        print(f"FAILURE in basic_chatbot_v0: {e}")
        return [{
            "role": "defender",
            "model_used": res_model,
